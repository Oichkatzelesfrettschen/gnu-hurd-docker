...
help:
	@echo "GNU Hurd Docker - Make Targets"
	@echo ""
	...
	@echo ""
	@echo "Build & Setup:"
	@echo "  make setup            - download and convert Debian Hurd QCOW2 image"
	@echo "  make build            - docker build via compose"
	@echo ""
	@echo "Operation:"
	@echo "  make up               - start container (TCG, compatible)"
	@echo "  make up-kvm           - start container with KVM acceleration"
	@echo "  make up-vnc           - start container with VNC display"
	@echo "  make up-kvm-vnc       - start container with KVM and VNC"
	@echo "  make up-volume        - start container with auto-download image (engine volume)"
	@echo "  make up-volume-vnc    - start with auto-download and VNC"
	@echo "  make down             - stop and remove container"
	@echo "  make logs             - follow container logs"
	@echo "  make shell            - open shell into running container"
	@echo ""
	@echo "Debugging:"
